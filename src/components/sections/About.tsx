            ...
            <div className="lg:col-span-5 flex items-end pb-12 md:pb-20 pl-0 lg:pl-14 pt-8 lg:pt-0">
              ...
              >
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 py-2 min-h-[44px] mt-6 font-sans text-[11px] text-magenta/60 uppercase tracking-[0.3em] hover:text-magenta transition-colors duration-500"
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <div className="mt-8 flex items-center gap-6">
                ...
                <Link
                  href="/contact"
                  className="py-2 min-h-[44px] font-sans text-[11px] text-magenta/50 uppercase tracking-[0.2em] hover:text-magenta transition-colors duration-500"
                >
                  Get in Touch
                </Link>
              </div>
